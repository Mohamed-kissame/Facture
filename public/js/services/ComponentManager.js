export class ComponentManager {
  ...
  createComponentElement(component) {
    ...
    <div class="component-controls">
      ...
      <div class="control-buttons">
        <button class="control-btn size-btn" title="Taille">📏</button>
        <button class="control-btn edit-btn" title="Modifier">✏️</button>
        <button class="control-btn remove-btn" title="Supprimer">🗑️</button>
      </div>
    </div>
  ...
  `
    ...
    element.querySelector(".size-btn").addEventListener("click", (e) => {
      e.stopPropagation()
      this.showSizeDialog(component.id)
    })
  ...
  updateComponentContent(componentId, data) {
    ...
    switch (component.type) {
      ...
      case "invoice-summary":
        ...
        break
      case "invoice-data":
        // For invoice data components, we'll handle this in loadDemoData
        break
    }
  }
